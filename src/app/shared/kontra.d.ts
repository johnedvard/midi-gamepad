declare namespace kontra {
  ...
  function onPointer(
    direction: 'down' | 'up',
    callback: (evt: MouseEvent | TouchEvent, object?: object) => void
  ): void;
  ...
  function onGesture(
    ...
    callback: (evt: TouchEvent, touches: object) => void
  ): void;
  ...
  function onInput(
    ...
    callback: Function,
    options?: { gamepad?: object; key?: object }
  ): void;
  function offInput(
    inputs: string | string[],
    options?: { gamepad?: object; key?: object }
